...
- Create Angular project with ng: `ng new helloangularnet.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`helloangularnet.client.esproj`).
